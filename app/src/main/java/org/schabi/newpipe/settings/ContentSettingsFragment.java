...
public class ContentSettingsFragment extends BasePreferenceFragment {
    ...
    public void onCreatePreferences(final Bundle savedInstanceState, final String rootKey) {
        ...
        disableOption(R.bool.adult_enabled, R.string.show_age_restricted_content);
        disableOption(R.bool.unsafe_enabled, R.string.youtube_restricted_mode_enabled);
        final TimeLogger tl = TimeLogger.Companion.getInstance(requireContext());
        disableOption(tl.rsEnabled(requireContext()), R.string.show_next_video_key);
...
//    if NOT buildvar, disable preferenceID
//    doesn't actually do anything other than make them invisible
//    still searchable
//    but since they're invisible, cannot be manipulated
    private void disableOption(final int buildvar, final int preferenceID) {
        disableOption(getContext().getResources().getBoolean(buildvar), preferenceID);
    }

    private void disableOption(final Boolean ifFalse, final int preferenceID) {
        if (ifFalse) {
            return;
        }
        final Preference pref = findPreference(getString(preferenceID));
