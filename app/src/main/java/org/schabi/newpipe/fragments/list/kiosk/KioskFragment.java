...
public class KioskFragment extends BaseListInfoFragment<StreamInfoItem, KioskInfo> {
    ...
    public static KioskFragment getInstance(final int serviceId, final String ingress)
            throws ExtractionException {
        return getInstance(serviceId, NewPipe.getService(serviceId)
                .getKioskList().getDefaultKioskId(), ingress);
    }

    public static KioskFragment getInstance(final int serviceId, final String kioskId,
                                            final String ingress)
            throws ExtractionException {
        final KioskFragment instance = new KioskFragment(ingress);
    ...
    public KioskFragment(final String ingress) {
