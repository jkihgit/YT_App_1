...
public class RelatedItemsFragment extends BaseListInfoFragment<InfoItem, RelatedItemInfo>
    ...
    public static RelatedItemsFragment getInstance(final StreamInfo info, final String ingress) {
        final RelatedItemsFragment instance = new RelatedItemsFragment(ingress);
    ...
    public RelatedItemsFragment() {
        ...
        this.type = BaseListFragment.RELATED_FRAGMENT_TYPE;
    }

    public RelatedItemsFragment(final String ingress) {
        super(UserAction.REQUESTED_STREAM);
        this.type = BaseListFragment.RELATED_FRAGMENT_TYPE;
