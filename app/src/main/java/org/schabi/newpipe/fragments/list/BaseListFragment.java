...
public abstract class BaseListFragment<I, N> extends BaseStateFragment<I>
    ...
    public static final String VIDEO_DETAIL_FRAGMENT = "videoDetail";
    public static final String RELATED_FRAGMENT_TYPE = "related";
    public static final String CHANNEL_FRAGMENT_TYPE = "channel";
    public static final String PLAYLIST_FRAGMENT_TYPE = "playlist";
    public static final String BOOKMARK_FRAGMENT_TYPE = "bookmark";
    public static final String HISTORY_FRAGMENT_TYPE = "history";
    public static final String SUBSCRIPTION_FRAGMENT_TYPE = "subscription";
    public static final String COMMENT_HOLDER_TYPE = "comments";
    protected org.schabi.newpipe.util.SavedState savedState;

    private boolean useDefaultStateSaving = true;
    private int updateFlags = 0;
    protected String type = "unknown remote list";
    protected String ingress = "unknown";
        ...
        infoListAdapter.setOnChannelSelectedListener(selectedItem -> {
            try {
                ...
                NavigationHelper.openChannelFragment(getFM(), selectedItem.getServiceId(),
                        selectedItem.getUrl(), selectedItem.getName(), this.type);
    ...
    private void onStreamSelected(final StreamInfoItem selectedItem) {
        onItemSelected(selectedItem);
        final TimeLogger tl = TimeLogger.Companion.getInstance(getContext());
        tl.markIngress(this.type, this.ingress, getContext());
        if ((Objects.equals(this.type, RELATED_FRAGMENT_TYPE)) || (
                Objects.equals(this.type, VIDEO_DETAIL_FRAGMENT)
                )) {
